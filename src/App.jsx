...
function App() {
  ...
  const extractExperienceAndSkills = (text) => {
    ...
    const yearsMatch = cleanText.match(
    ...
    const jobTitles =
      cleanText.match(
        /(?:Intern|Engineer|Developer|Analyst|Manager|Specialist|Consultant|Associate)\s*(?:at|@|\-)\s*([A-Za-z\s&]+)/gi
      ) || [];
    const companies = jobTitles
      .map((title) => title.split(/at|@|\-/)[1]?.trim())
      .filter(Boolean)
      .slice(0, 3);
    ...
    return {
      ...
      summary:
        summary.trim() || "strong technical background and relevant experience",
    };
  };
...
With my background and experience, I believe I would be a valuable addition to your team. My ${
            extractedData.summary || extractedData.experience
          } aligns well with the requirements outlined in your job posting.
...
What particularly excites me about this opportunity is the chance to apply my skills in a dynamic environment. My ${
            extractedData.summary || extractedData.experience
          } has prepared me well for this role, and I am eager to bring my passion and dedication to your team.
...
${
  extractedData.skills
    ? `• Technical expertise in ${extractedData.skills}`
...
Your commitment to excellence aligns perfectly with my professional values and career aspirations. My ${
            extractedData.summary || extractedData.experience
          } has equipped me with the skills necessary to contribute meaningfully to your team from day one.
...
Throughout my career, I have consistently delivered exceptional results and exceeded expectations. My ${
            extractedData.summary || extractedData.experience
          } demonstrates my ability to contribute significantly to your organization's goals.
...
Your company's vision for the future resonates strongly with my professional goals and aspirations. My ${
            extractedData.summary || extractedData.experience
          } has prepared me to tackle the challenges and opportunities that lie ahead in this role.
...
${extractedData.email}`,
  ...
  message: template.body,   // ✅ send only the plain text or HTML string
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-orange-100">
              Upload your resume, generate personalized email templates, and
              send them directly to HR
            </p>
          </div>
        </div>
      </div>
              ...
              {extractedData.name && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-left text-blue-600">
                    ...
                    {extractedData.skills && (
                      <p>
                        <strong>Skills:</strong> {extractedData.skills}
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  💡 Tip: For best results, start with the job title or paste
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-2 border border-orange-400 rounded-md bg-white shadow-sm focus:ring-2 focus:ring-orange-500"
                />

                {/* Display extracted user email nearby */}
                {/* Show extracted email here if available */}
                {extractedData.email && (
                  <div
                    style={{
                      backgroundColor: "#fff",
                  ...
                  >
                    📧 Your email: <strong>{extractedData.email}</strong>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                disabled={
                  isGenerating || !extractedData.name || !jobDescription
                }
          ...
          {showTemplates && emailTemplates.length > 0 && (
            <div className="bg-white rounded-lg shadow-lg border p-6 mb-6">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800">
                  Step 4: Choose & Send Email Template
                </h2>
              </div>
